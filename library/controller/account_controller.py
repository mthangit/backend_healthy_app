...
from ..services.account_services import account_exists, get_info_by_email, get_info_by_account_id
...
@accounts.route('/api/get-account-info', methods=['GET'])
def get_account():
	email = request.args.get('email')
	if not email:
		return get_info_by_account_id()
	return get_info_by_email(email)
